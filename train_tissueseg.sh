#!/bin/bash
# Tissue Segmentation Training Launch Script
# 0.4mm resolution, 19-class, DiceCELoss. Data preprocessed: RAS, remapped labels 0..18.
...
TRAIN_SCRIPT="$(dirname "$0")/train_tissueseg.py"
...
DATA_ROOT="${DATA_ROOT:-/home/weiyahui/projects/monkey/dataset/tissue_segmentation}"
...
OUTPUT_DIR="${OUTPUT_DIR:-/home/weiyahui/projects/monkey/macaBrainNet_v2/swinunetr_models/tissue_segmentation/fold_${FOLD:-1}}"

echo "========================================"
echo "Tissue Segmentation Training"
